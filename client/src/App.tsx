...
function App() {
  ...
  // Authenticated user view - stable interface
  if (user) {
    return (
      <div style={{
        minHeight: '100vh',
        ...
        <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#48bb78' }}>$2,000</div>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, color: '#e2e8f0' }}>
              Your Global Trade Tycoon is ready! Authentication working perfectly.
            </p>
          </div>
        </div>
      </div>
